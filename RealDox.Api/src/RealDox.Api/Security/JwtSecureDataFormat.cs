...
namespace RealDox.Api.Security
{
    ...
    public class JwtSecureDataFormat : ISecureDataFormat<AuthenticationTicket>
    {
        ...
        {
            throw new NotImplementedException("Cookie protection not implemented yet");
        }

        public string Protect(AuthenticationTicket data, string purpose)
        {
            throw new NotImplementedException("Cookie protection with a purpose not implemented yet");
        }
    }
}
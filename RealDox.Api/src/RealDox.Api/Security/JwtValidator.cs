...
namespace RealDox.Api.Security
{
    ...
    public class JwtValidator : JwtSecurityTokenHandler
    {
        ...
        public override ClaimsPrincipal ValidateToken(string securityToken, TokenValidationParameters validationParameters, out SecurityToken validatedToken)
        {
            ...
            {
                throw new SecurityTokenValidationException("Fatal Error: invalid algorithm");
            }

            // Checks if the token has been revoked.
            if (_invalidTokenDictionary.ContainsKey(validatedToken.Id))
            {
                throw new SecurityTokenValidationException("Fatal Error: invalid token");
            }

            return principal;
        }

        public JwtSecurityToken CreateToken(IEnumerable<Claim> claims, JwtOptions jwtOptions)
        {
            ...
            /*var newJwt = new JwtSecurityToken(
                ...
                /*All Cripthographic algorithms in this class: Microsoft.IdentityModel.Tokens.SecurityAlgorithms */
